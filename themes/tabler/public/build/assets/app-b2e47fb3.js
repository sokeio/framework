...
(function(factory) {
  ...
  function objectIncludes(b, a2) {
    if (a2 === b)
      return true;
    var arrA = Array.isArray(a2), arrB = Array.isArray(b), i2;
    if (arrA && arrB) {
      if (a2.length != b.length)
        return false;
      for (i2 = 0; i2 < a2.length; i2++) {
        if (!objectIncludes(a2[i2], b[i2]))
          return false;
      }
      return true;
    }
    ...
    if (a2 && b && _typeof(a2) === "object" && _typeof(b) === "object") {
      ...
      for (i2 = 0; i2 < keys.length; i2++) {
        if (!objectIncludes(b[keys[i2]], a2[keys[i2]]))
          return false;
      }
      return true;
  ...
  var PatternCursor = function() {
    function PatternCursor2(masked, pos) {
      ...
      var _ref = masked._mapPosToBlock(pos) || (pos < 0 ? {
        ...
        offset: 0
      }), offset2 = _ref.offset, index = _ref.index;
      this.offset = offset2;
      this.index = index;
      this.ok = false;
    }
  ...
  switchesTriggerList.map(function(switchTriggerEl) {
    switchTriggerEl.addEventListener("click", function(e2) {
      e2.stopPropagation();
      switchTriggerEl.classList.toggle("active");
    });
  });
  var EnableActivationTabsFromLocationHash = function EnableActivationTabsFromLocationHash2() {
  ...
  var prefix = "tblr-";
  var hexToRgba = function hexToRgba2(hex, opacity) {
