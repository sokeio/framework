<div class="p-3">
    <div class="row">
        <div class="{{ column_size('col4') }}">
            <div class="accordion bg-white" id="accordion-menu" wire:ignore>
                <div class="accordion-item">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="menu-header-link">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                data-bs-target="#menu-link" aria-expanded="false">
                                Links
                            </button>
                        </h2>
                        <div id="menu-link" class="accordion-collapse" data-bs-parent="#accordion-menu">
                            <div class="accordion-body pt-0" x-data="{
                                ...
                                async doAddMenu() {
                                    if (await this.$wire.doAddMenu({ link: this.custom_url, name: this.custom_name, class: this.custom_class })) {
                                        this.resetData();
                                    }
                                }
                            }">
