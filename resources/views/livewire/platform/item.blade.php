<div class="col-6 col-md-4 col-lg-3" wire:init='loadLastVersion()'>
    <div class="card card-sm">
        ...
        <div class="card-body p-2">
            <div class="d-flex ">
                <div class="me-auto">{{ $item->getTitle() }} @if ($item->isVendor())
                        (Vendor)
                    @endif
                </div>
                <div class="">
                    <span class="badge bg-primary text-bg-primary">{{ $item->getVersion() }}-{{ $lastVersion }}</span>
                </div>
            </div>
