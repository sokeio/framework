...
class PlatformManager
{
    ...
    public function registerComposer($path, $resgister = false)
    {
        ...
        collect(JsonData::getValueByKey($composer, 'autoload.files', []))
    ...
    public function getModels()
    {
        ...
        return applyFilters(PLATFORM_MODEL_LIST, $arr);
    }
    ...
    private function registerPermissionGates()
    {
        ...
        $permissions->map(function ($permission) {
            Gate::define($permission->slug, function ($user = null) use ($permission) {
                ...
                if (!$user || !applyFilters(PLATFORM_CHECK_PERMISSION, true,  $permission, $user)) {
                    return false;
                }
